...
def determine_season():
    # Define valid months for validation
    ...
    try:
        ...
        if month not in months:
            print("Invalid month! Please use the three-character format (Jan, Feb, Mar, etc).")
            return
        ...
        if (month == 'Dec' and day >= 21) or month in ('Jan', 'Feb') or (month == 'Mar' and day <= 19):
            ...
            # Remaining dates are Sep 22 - Dec 20, which are in Fall
            season = "Fall"
